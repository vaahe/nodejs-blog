...
export const Modal = () => {
    ...
    return (
        <div className="w-screen h-screen absolute top-20 left-15 border border-black">
            <div className="text-center font-bold text-2xl m-5 text-gray-800">New Post</div>
            <form className="rounded-md mx-auto w-10/12 flex flex-col text-gray-800 border border-gray-300 p-4 shadow-lg max-w-2xl" onSubmit={handleSubmit}>
                ...
                <div className="flex">
                    <button className="btn border border-gray-300 rounded-md p-1 px-4 font-semibold cursor-pointer text-[#1f2937] ml-auto">
                        Cancel
                    </button>
